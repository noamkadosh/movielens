...
We can see that the histogram is left skewed, implying more movies have negative effects.

```{r movie_effect_mode;, echo = TRUE}
...
We can see that considering the movie penalty term improves our RMSE result.
